        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
              ...
              <span
                className={cn(
                  "bg-clip-text text-3xl sm:text-3xl md:text-6xl text-transparent bg-gradient-to-r from-indigo-300 via-white/90 to-rose-300"
                )}
              >
                I Build Modern Full-Stack Apps
              </span>
            </h1>
          </motion.div>
          ...
          >
            <p className="text-base sm:text-lg md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
              Crafting responsive UIs and full-stack web apps with clean code and creativity.
            </p>
          </motion.div>
          ...
          >
            ...
            <Button
  onClick={() => window.open("/Harini_developer.pdf", "_blank")}
  className=" "
>
  Resume
</Button>
